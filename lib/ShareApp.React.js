    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { className: "col-lg-3" },
          React.createElement(ExpenseList, { users: this.state.users, _users: this.state._users, expenses: this.state.expenses, onCheckExpenseUser: this.handleCheckExpenseUser })
        ),
        React.createElement(
          "div",
          { className: "col-lg-3" },
...
var ExpenseItem = React.createClass({
  ...
  render: function render() {
    ...
    var deleteButton = React.createElement("i", { className: "glyphicon glyphicon-trash" });
...
React.render(React.createElement(ShareApp, { users: USERS, _users: _USERS, expenses: EXPENSES }), document.getElementById('share-app'));